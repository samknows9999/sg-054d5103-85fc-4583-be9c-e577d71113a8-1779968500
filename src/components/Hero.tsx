  ...
  return (
    <section className="relative min-h-[60vh] flex items-center pt-32 pb-20 md:pt-40 overflow-hidden bg-[#061124]">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 w-full mt-8">
        ...
        <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] max-w-4xl shadow-sm">Business Restructuring & Financial Advisory

        </h1>
        
        {subtitle &&
        <p className="text-xl md:text-2xl text-gray-300 mt-8 max-w-3xl leading-relaxed font-light">Helping businesses regain financial stability through strategic restructuring, creditor coordination, cash flow improvement, and experienced financial advisory services. Trusted by businesses for over 21 years.
