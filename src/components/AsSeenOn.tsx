        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-12">
          ...
          <a
            ...
            className="group">
              ...
              <div className="border border-gray-200 rounded-xl p-6 h-full flex flex-col items-center justify-center gap-3 hover:border-primary hover:shadow-lg hover:bg-white transition-all duration-300 cursor-pointer" style={{ backgroundImage: "url(\"/CEO.png\")", backgroundColor: "transparent", backgroundSize: "cover" }}>
